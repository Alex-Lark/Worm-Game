...
public static class GameParameters
{
    ...
    public static readonly int DefaultTimePerCreatureBuilding = 600;
    public static readonly int DefaultTimePerMinigame = 10000;
    ...
    public static readonly float WormMaxVelocity = 5f;
