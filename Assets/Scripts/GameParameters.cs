...
public static class GameParameters
{
    ...
    public static readonly int TimeForLeaderboard = 3;
    ...
    public static readonly float WormHeadRotationSpeed = 3f;
    ...
    public static readonly bool IsInvincibleInGame = false;
